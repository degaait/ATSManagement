    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CivilJusticeNewRequestViewModel",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
                name: "LegalStudiesNewRequestViewModel",
                columns: table => new
                {
                    OrderID = table.Column<int>(type: "int", nullable: true),
                    RequestID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "tbl_InternalRequestStatus",
                columns: table => new
                {
                    RequestStatusID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    StatusName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    StatusWithColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StatusNameAmharic = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    StatusWithColorAmharic = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalRequestStatus", x => x.RequestStatusID);
                });

            migrationBuilder.CreateTable(
                name: "tbl_InternalServiceTypes",
                columns: table => new
                {
                    ...
                    ServiceResultEnglish = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceResultAmharic = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalServiceTypes", x => x.ServiceTypeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    forSecretary = table.Column<bool>(type: "bit", nullable: true),
                    forBranchOfficer = table.Column<bool>(type: "bit", nullable: true),
                    forInternalUser = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Defendant_info = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitConfrence = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DepartmentReview = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SendTo = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ForStateMinister = table.Column<bool>(type: "bit", nullable: true),
                    ForExpert = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InspectionChat", x => x.ChatId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InspectionReports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_tbl_InspectionReports_tbl_Inistitutions",
                        column: x => x.InistId,
                        principalTable: "tbl_Inistitutions",
                        principalColumn: "InistId");
                    table.ForeignKey(
                        name: "FK_tbl_InspectionReports_tbl_InspectionLaws",
                        column: x => x.LawId,
                        principalTable: "tbl_InspectionLaws",
                        principalColumn: "LawId");
                    table.ForeignKey(
                        name: "FK_tbl_InspectionReports_tbl_RecomendationStatus",
                        column: x => x.RecostatusId,
                        principalTable: "tbl_RecomendationStatus",
                        principalColumn: "RecostatusID");
                    table.ForeignKey(
                        name: "FK_tbl_InspectionReports_tbl_Years",
                        column: x => x.YearId,
                        principalTable: "tbl_Years",
                        principalColumn: "YearID");
                });
            ...
            migrationBuilder.CreateTable(
                name: "tbl_InternalDocumentHistories",
                columns: table => new
                {
                    HistoryID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    RequestID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalDocumentHistories", x => x.HistoryID);
                });

            migrationBuilder.CreateTable(
                name: "tbl_InternalRequestAssignees",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalRequestAssignees", x => x.AssigneeRequestId);
                });

            migrationBuilder.CreateTable(
                name: "tbl_InternalRequestChats",
                columns: table => new
                {
                    ChatId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalRequestChats", x => x.ChatId);
                });

            migrationBuilder.CreateTable(
                name: "tbl_InternalRequests",
                columns: table => new
                {
                    RequestID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                    RequestDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequestedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    IsAssignedToexpert = table.Column<bool>(type: "bit", nullable: true),
                    AssignedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AssignedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    DueDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    AssingmentRemark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_InternalRequests", x => x.RequestID);
                    table.ForeignKey(
                        name: "FK_tbl_InternalRequests_tbl_InternalRequestStatus",
                        column: x => x.RequestStatusID,
                        principalTable: "tbl_InternalRequestStatus",
                        principalColumn: "RequestStatusID");
                    table.ForeignKey(
                        name: "FK_tbl_InternalRequests_tbl_InternalServiceTypes",
                        column: x => x.ServiceTypeID,
                        principalTable: "tbl_InternalServiceTypes",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBranchOfficeUser = table.Column<bool>(type: "bit", nullable: true),
                    IsInternalRequestUser = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mens = table.Column<int>(type: "int", nullable: true),
                    Womens = table.Column<int>(type: "int", nullable: true),
                    Disablities = table.Column<int>(type: "int", nullable: true),
                    HIVPositive = table.Column<int>(type: "int", nullable: true),
                    GovernmentInstitutes = table.Column<int>(type: "int", nullable: true),
                    Other = table.Column<int>(type: "int", nullable: true),
                    Childrens = table.Column<int>(type: "int", nullable: true),
                    Elders = table.Column<int>(type: "int", nullable: true),
                    PersecutionReturnies = table.Column<int>(type: "int", nullable: true),
                    MensInvestigations = table.Column<int>(type: "int", nullable: true),
                    WomensInvestigations = table.Column<int>(type: "int", nullable: true),
                    DisablitiesInvestigation = table.Column<int>(type: "int", nullable: true),
                    HIVPositiveInvestigation = table.Column<int>(type: "int", nullable: true),
                    GovernmentInstitutesInvestigations = table.Column<int>(type: "int", nullable: true),
                    OtherInvestigations = table.Column<int>(type: "int", nullable: true),
                    ChildrensInvestigations = table.Column<int>(type: "int", nullable: true),
                    EldersInvestigations = table.Column<int>(type: "int", nullable: true),
                    PersecutionReturniesInvestigations = table.Column<int>(type: "int", nullable: true),
                    totalInvestigations = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionChat_SendBy",
                table: "tbl_InspectionChat",
                column: "SendBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionChat_SendTo",
                table: "tbl_InspectionChat",
                column: "SendTo");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionChat_SpecificPlanId",
                table: "tbl_InspectionChat",
                column: "SpecificPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionChat_UserId",
                table: "tbl_InspectionChat",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionReports_CreatedBy",
                table: "tbl_InspectionReports",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionReports_InistId",
                table: "tbl_InspectionReports",
                column: "InistId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionReports_LawId",
                table: "tbl_InspectionReports",
                column: "LawId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionReports_RecostatusId",
                table: "tbl_InspectionReports",
                column: "RecostatusId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InspectionReports_YearId",
                table: "tbl_InspectionReports",
                column: "YearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalDocumentHistories_CreatedBy",
                table: "tbl_InternalDocumentHistories",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalDocumentHistories_RequestID",
                table: "tbl_InternalDocumentHistories",
                column: "RequestID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequestAssignees_RequestID",
                table: "tbl_InternalRequestAssignees",
                column: "RequestID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequestAssignees_UserID",
                table: "tbl_InternalRequestAssignees",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequestChats_SendBy",
                table: "tbl_InternalRequestChats",
                column: "SendBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequestChats_SendTo",
                table: "tbl_InternalRequestChats",
                column: "SendTo");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequestChats_UserId",
                table: "tbl_InternalRequestChats",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequests_AssignedBy",
                table: "tbl_InternalRequests",
                column: "AssignedBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequests_RequestedBy",
                table: "tbl_InternalRequests",
                column: "RequestedBy");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequests_RequestStatusID",
                table: "tbl_InternalRequests",
                column: "RequestStatusID");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_InternalRequests_ServiceTypeID",
                table: "tbl_InternalRequests",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InspectionChat_tbl_InternalUsers",
                table: "tbl_InspectionChat",
                column: "SendTo",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InspectionChat_tbl_InternalUsers1",
                table: "tbl_InspectionChat",
                column: "SendBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InspectionChat_tbl_InternalUsers2",
                table: "tbl_InspectionChat",
                column: "UserId",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InspectionChat_tbl_SpecificPlans",
                table: "tbl_InspectionChat",
                column: "SpecificPlanId",
                principalTable: "tbl_SpecificPlans",
                principalColumn: "SpecificPlanId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InspectionReports_tbl_InternalUsers",
                table: "tbl_InspectionReports",
                column: "CreatedBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalDocumentHistories_tbl_InternalRequests",
                table: "tbl_InternalDocumentHistories",
                column: "RequestID",
                principalTable: "tbl_InternalRequests",
                principalColumn: "RequestID");

            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalDocumentHistories_tbl_InternalUsers",
                table: "tbl_InternalDocumentHistories",
                column: "CreatedBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequestAssignees_tbl_InternalRequests",
                table: "tbl_InternalRequestAssignees",
                column: "RequestID",
                principalTable: "tbl_InternalRequests",
                principalColumn: "RequestID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequestAssignees_tbl_InternalUsers",
                table: "tbl_InternalRequestAssignees",
                column: "UserID",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequestChats_tbl_InternalUsers",
                table: "tbl_InternalRequestChats",
                column: "UserId",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequestChats_tbl_InternalUsers1",
                table: "tbl_InternalRequestChats",
                column: "SendBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequestChats_tbl_InternalUsers2",
                table: "tbl_InternalRequestChats",
                column: "SendTo",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequests_tbl_InternalUsers",
                table: "tbl_InternalRequests",
                column: "RequestedBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_tbl_InternalRequests_tbl_InternalUsers1",
                table: "tbl_InternalRequests",
                column: "AssignedBy",
                principalTable: "tbl_InternalUsers",
                principalColumn: "UserID");
